/**
 * UI-only static district data for Indian States and Union Territories.
 *
 * This is NOT legal-source data and is NOT used for legal matching.
 * It exists solely so the district dropdown works in the frontend.
 * District names are representative and not exhaustive.
 */
...
export const DISTRICTS_BY_STATE: Record<string, string[]> = {
  ...
  Chhattisgarh: [
    ...
    "Gaurela Pandaria", "Janjgir Champa", "Jashpur", "Kabirdham",
  ...
  Sikkim: [
    "Gangtok", "Mangan", "Namchi", "Gyalshing", "Ravong", "Pakyong",
    "Soreng", "Pelling",
  ],
  "Tamil Nadu": [
